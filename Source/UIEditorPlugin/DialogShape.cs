...
namespace UIEditorPlugin
{
  ...
  public class NodeShape : Shape3D
    ...
    /// </summary>
    UIEngineInstanceDialog EngineNode {get {return (UIEngineInstanceDialog)_engineInstance;}}
    ...
    public override void OnLink(ShapeLink src, ShapeLink target)
    {
      ...
      if (src.OwnerShape==this && (target is BidirectionalNodeLink))
        this.EngineNode.LinkNode((UIEngineInstanceDialog)target.OwnerShape._engineInstance);
      if (target.OwnerShape==this && (src is BidirectionalNodeLink))
        this.EngineNode.LinkNode((UIEngineInstanceDialog)src.OwnerShape._engineInstance);
    }
