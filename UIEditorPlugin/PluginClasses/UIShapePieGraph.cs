...
{   
    [Serializable]
    public class UIShapePieGraph : UIShapeBase
    {
        public UIShapePieGraph(string name)
            : base(name)
        {
            IconIndex = UIShapeBase.GetIconIndex("UIEditorPlugin.Icons.Button.png");

            UIProperties = UIManager.CreateCollection(this, "VUINodePieGraph");
        ...
        protected UIShapePieGraph(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
...
//                     }
        ...
        public override void CreateEngineInstance(bool bCreateChildren)
        {
            ...
            {
                _engineInstance = new UIEngineInstanceShape2D("VUINodePieGraph");
    ...
    /// </summary>
    class PieGraphShapeCreator : CSharpFramework.IShapeCreatorPlugin
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public PieGraphShapeCreator()
        {
            IconIndex = UIShapeBase.GetIconIndex("UIEditorPlugin.Icons.Button.png");
        }
        ...
        {
            UIShapePieGraph shape = new UIShapePieGraph("PieGraph");
