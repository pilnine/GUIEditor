...
{   
    [Serializable]
    public class UIShapeModelPreview : UIShapeBase
    {
        public UIShapeModelPreview(string name)
            : base(name)
        {
            IconIndex = UIShapeBase.GetIconIndex("UIEditorPlugin.Icons.Button.png");

            UIProperties = UIManager.CreateCollection(this, "VUINodeModelPreviewControl");
        ...
        protected UIShapeModelPreview(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        ...
        private string controlClass = "VUINodeStyleButton";
...
//                     }
        ...
        public UIEngineInstanceShape2D UIModelPreviewInstance { get { return (UIEngineInstanceShape2D)_engineInstance; } }
        ...
        public override void CreateEngineInstance(bool bCreateChildren)
        {
            ...
            {
                _engineInstance = new UIEngineInstanceShape2D("VUINodeModelPreviewControl");
    ...
    /// </summary>
    class ModelPreviewShapeCreator : CSharpFramework.IShapeCreatorPlugin
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        {
            UIShapeModelPreview shape = new UIShapeModelPreview("ModelPreview");
