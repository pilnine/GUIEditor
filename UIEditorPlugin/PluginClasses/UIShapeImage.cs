...
namespace UIEditorPlugin
{
    ...
    /// </summary>
    [Serializable]
    public class UIShapeImage : UIShapeBase //, ImageState
    {
        /// <summary>
        ...
        protected UIShapeImage(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        ...
        public UIEngineInstanceImage UIImageInstance { get { return (UIEngineInstanceImage)_engineInstance; } }
        ...
        public override void CreateEngineInstance(bool bCreateChildren)
        {
            ...
            {
                _engineInstance = new UIEngineInstanceImage();
    ...
    /// </summary>
    class ImageShapeCreator : CSharpFramework.IShapeCreatorPlugin
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        {
            UIShapeImage shape = new UIShapeImage("Image");
