...
{   
    [Serializable]
    public class UIShapeCheckBox : UIShapeBase
    {
        public UIShapeCheckBox(string name)
            : base(name)
        {
            IconIndex = UIShapeBase.GetIconIndex("UIEditorPlugin.Icons.Button.png");

            UIProperties = UIManager.CreateCollection(this, "VUINodeCheckBox");
        ...
        protected UIShapeCheckBox(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {            
       ...
       /// <summary>
        ...
        public UIEngineInstanceShape2D UICheckBoxInstance { get { return (UIEngineInstanceShape2D)_engineInstance; } }
        ...
        public override void CreateEngineInstance(bool bCreateChildren)
        {
            ...
            {
                _engineInstance = new UIEngineInstanceShape2D("VUINodeCheckBox");
    ...
    /// </summary>
    class CheckBoxShapeCreator : CSharpFramework.IShapeCreatorPlugin
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public CheckBoxShapeCreator()
        {
            IconIndex = UIShapeBase.GetIconIndex("UIEditorPlugin.Icons.Button.png");
        }
        ...
        {
            UIShapeCheckBox shape = new UIShapeCheckBox("CheckBox");
