...
{   
    [Serializable]
    public class UIShapeRotator : UIShapeBase
    {
        ...
        protected UIShapeRotator(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
...
//                     }
        ...
        public override void CreateEngineInstance(bool bCreateChildren)
        {
            ...
            {
                _engineInstance = new UIEngineInstanceShape2D("VUINodeRotator");
    ...
    /// </summary>
    class RotatorShapeCreator : CSharpFramework.IShapeCreatorPlugin
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        {
            UIShapeRotator shape = new UIShapeRotator("Rotator");
