...
namespace UIEditorPlugin
{
  ...
  #region class DialogShape
	...
	/// </summary>
  [Serializable]
  public class DialogShape : Shape3D
	{
    #region Constructor
    ...
    /// <param name="name">Name of the shape in the shape tree</param>
		public DialogShape(string name) : base(name)
		{
    }
    ...
    /// <param name="info"></param>
    /// <param name="context"></param>
    protected DialogShape(SerializationInfo info, StreamingContext context) : base(info, context)
    {
      //..nothing to do
    }
  ...
  class DialogShapeCreator : CSharpFramework.IShapeCreatorPlugin
  {
    ...
    {
      DialogShape shape = new DialogShape("Dialog");
