...
{   
    [Serializable]
    public class UIShapeStyleButton : UIShapeBase
    {
        public UIShapeStyleButton(string name)
            : base(name)
        {
            IconIndex = UIShapeBase.GetIconIndex("UIEditorPlugin.Icons.Button.png");      

            UIProperties = UIManager.CreateCollection(this, "VUINodeStyleButton");
        ...
        protected UIShapeStyleButton(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
...
//                     }
    ...
    /// </summary>
    class PushStyleButtonShapeCreator : CSharpFramework.IShapeCreatorPlugin
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public PushStyleButtonShapeCreator()
        {
            IconIndex = UIShapeBase.GetIconIndex("UIEditorPlugin.Icons.Button.png");
        }
        ...
        {
            UIShapeStyleButton shape = new UIShapeStyleButton("PushStyleButton");
