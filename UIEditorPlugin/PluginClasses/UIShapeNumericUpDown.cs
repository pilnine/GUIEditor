...
{   
    [Serializable]
    public class UIShapeNumericUpDown : UIShapeBase
    {
        ...
        protected UIShapeNumericUpDown(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {            
       ...
       /// <summary>
        ...
        public UIEngineInstanceShape2D UINumericUpDownInstance { get { return (UIEngineInstanceShape2D)_engineInstance; } }
        ...
        public override void CreateEngineInstance(bool bCreateChildren)
        {
            ...
            {
                _engineInstance = new UIEngineInstanceShape2D("VUINodeNumericUpDown");
    ...
    /// </summary>
    class NumericUpDownShapeCreator : CSharpFramework.IShapeCreatorPlugin
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        {
            UIShapeNumericUpDown shape = new UIShapeNumericUpDown("NumericUpDown");
