...
namespace UIEditorPlugin
{
    ...
    /// </summary>
    [Serializable]
    public class UIShapeSliderControl : UIShapeBase //, ImageState
    {
        /// <summary>
        ...
        protected UIShapeSliderControl(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        ...
        public UIEngineInstanceSliderControl UIImageInstance { get { return (UIEngineInstanceSliderControl)_engineInstance; } }
        ...
        public override void CreateEngineInstance(bool bCreateChildren)
        {
            ...
            {
                _engineInstance = new UIEngineInstanceSliderControl();
                ...
                else if (Parent is UIShapeListControl) // Can be attached to ListControl
                {
                    ((UIShapeListControl)Parent).AddUIControlInstance(this);
                }
    ...
    /// </summary>
    class SliderControlShapeCreator :CSharpFramework.IShapeCreatorPlugin
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        {
            UIShapeSliderControl shape = new UIShapeSliderControl("SliderControl");
